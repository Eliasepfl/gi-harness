...
* ``tools``    — the FROZEN read/oracle tools (§3 P1) as a typed function-calling
  registry: the three oracle-spine tools ``design`` / ``certify`` /
  ``retrieve_parts`` plus the engine-free static analyzer ``inspect_world``.
